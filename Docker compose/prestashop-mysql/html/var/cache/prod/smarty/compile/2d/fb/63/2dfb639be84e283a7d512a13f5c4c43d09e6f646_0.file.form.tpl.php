...
/* Smarty version 3.1.33, created on 2019-11-12 20:05:53
  from '/var/www/html/admin/themes/default/template/controllers/orders/form.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.33',
  'unifunc' => 'content_5dcb0291a763e6_28318260',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '2dfb639be84e283a7d512a13f5c4c43d09e6f646' => 
    array (
...
function content_5dcb0291a763e6_28318260 (Smarty_Internal_Template $_smarty_tpl) {
...
";
	...
	var current_index = '<?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'escape' ][ 0 ], array( $_smarty_tpl->tpl_vars['current']->value,'html','UTF-8' ));?>
...
if ($_from !== null) {
foreach ($_from as $_smarty_tpl->tpl_vars['module']->value => $_smarty_tpl->tpl_vars['id_order_state']->value) {
?>
...
', {
					...
					parse: function(data) {
						if (!data.found)
							$('#vouchers_err').html('<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'No voucher was found','d'=>'Admin.Orderscustomers.Notification','js'=>1),$_smarty_tpl ) );?>
').show();
						else
							$('#vouchers_err').hide();
						var mytab = new Array();
...
",
		...
		$('#customer_part').on('click','button.setup-customer',function(e){
			...
			$(this).removeClass('setup-customer').addClass('change-customer').html('<i class="icon-refresh"></i>&nbsp;<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>"Change",'js'=>1),$_smarty_tpl ) );?>
').blur();
...
",
    ...
    var customer_view_url_template = '<?php echo $_smarty_tpl->tpl_vars['link']->value->getAdminLink('AdminCustomers',true,array(),array('viewcustomer'=>1,'liteDisplaying'=>1,'id_customer'=>0));?>
';
        ...
        if (res.found) {
          ...
          $.each(res.customers, function () {
            ...
            html += '<a href="' + customer_view_url + '" class="btn btn-default fancybox"><i class="icon-search"></i> <?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Details','d'=>'Admin.Global','js'=>1),$_smarty_tpl ) );?>
</a>';
            html += '<button type="button" data-customer="' + this.id_customer + '" class="setup-customer btn btn-default pull-right" id="choose_customer_btn"><i class="icon-arrow-right"></i> <?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Choose','d'=>'Admin.Actions','js'=>1),$_smarty_tpl ) );?>
</button>';
            html += '</div>';
            html += '</div>';
            html += '</div>';
          ...
          html = '<div class="alert alert-warning"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'No customers found','d'=>'Admin.Orderscustomers.Notification','js'=>1),$_smarty_tpl ) );?>
</div>';
        }
			...
			success : function(res)
			{
				if(res.found)
				{
					...
					$.each(res.carts, function() {
						...
						html_carts += '<a title="<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'View this cart','d'=>'Admin.Orderscustomers.Feature','js'=>1),$_smarty_tpl ) );?>
...
&liteDisplaying=1#"><i class="icon-search"></i>&nbsp;<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Details','d'=>'Admin.Global','js'=>1),$_smarty_tpl ) );?>
</a>';
						html_carts += '&nbsp;<a href="#" title="<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Use this cart','d'=>'Admin.Orderscustomers.Feature','js'=>1),$_smarty_tpl ) );?>
" class="use_cart btn btn-default" rel="'+this.id_cart+'"><i class="icon-arrow-right"></i>&nbsp;<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>"Use",'d'=>'Admin.Orderscustomers.Feature','js'=>1),$_smarty_tpl ) );?>
</a>';
						html_carts += '</td>';
						html_carts += '</tr>';
					});
					...
					$.each(res.orders, function() {
						...
						html_orders += '<a href="<?php echo $_smarty_tpl->tpl_vars['link']->value->getAdminLink('AdminOrders',true,array(),array('vieworder'=>1,'liteDisplaying'=>1));?>
&id_order='+this.id_order+'#" title="<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'View this order','d'=>'Admin.Orderscustomers.Feature','js'=>1),$_smarty_tpl ) );?>
" class="fancybox btn btn-default"><i class="icon-search"></i>&nbsp;<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>"Details",'d'=>'Admin.Global','js'=>1),$_smarty_tpl ) );?>
</a>';
						html_orders += '&nbsp;<a href="#" "title="<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Duplicate this order','d'=>'Admin.Orderscustomers.Feature','js'=>1),$_smarty_tpl ) );?>
" class="duplicate_order btn btn-default" rel="'+this.id_order+'"><i class="icon-arrow-right"></i>&nbsp;<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>"Use",'d'=>'Admin.Orderscustomers.Feature','js'=>1),$_smarty_tpl ) );?>
</a>';
						html_orders += '</td>';
						html_orders += '</tr>';
					});
	...
	function updateDeliveryOptionList(delivery_option_list)
	{
		...
		{
			$('#carrier_form').hide();
			$('#carriers_err').show().html('<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'No carrier can be applied to this order','d'=>'Admin.Orderscustomers.Notification','js'=>1),$_smarty_tpl ) );?>
');
...
",
			...
			success : function(res)
			{
				...
				if(res.found)
				{
					...
					$('#products_found').show();
					products_found += '<label class="control-label col-lg-3"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Product','d'=>'Admin.Global','js'=>1),$_smarty_tpl ) );?>
</label><div class="col-lg-6"><select id="id_product" onclick="display_product_attributes();display_product_customizations();"></div>';
					attributes_html += '<label class="control-label col-lg-3"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Combination','d'=>'Admin.Global','js'=>1),$_smarty_tpl ) );?>
					...
					$.each(res.products, function() {
						...
						{
							customization_html += '<div class="bootstrap"><div class="panel"><div class="panel-heading"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Customization','d'=>'Admin.Catalog.Feature','js'=>1),$_smarty_tpl ) );?>
				...
				{
					$('#products_found').hide();
					$('#products_err').html('<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'No products found','d'=>'Admin.Orderscustomers.Notification','js'=>1),$_smarty_tpl ) );?>
');
	...
	function updateCartProducts(products, gifts, id_address_delivery)
	{
		...
		$.each(gifts, function() {
			...
			cart_content += '<td><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Gift','js'=>1),$_smarty_tpl ) );?>
</td><td>'+this.cart_quantity+'</td><td><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Gift','d'=>'Admin.Orderscustomers.Feature','js'=>1),$_smarty_tpl ) );?>
</td></tr>';
		});
		...
		if (typeof(vouchers) == 'object')
			$.each(vouchers, function(){
				if (parseFloat(this.value_real) === 0 && parseInt(this.free_shipping) === 1)
					var value = '<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Free shipping','d'=>'Admin.Shipping.Feature','js'=>1),$_smarty_tpl ) );?>
';
				else
					var value = this.value_real;

				vouchers_html += '<tr><td>'+this.name+'</td><td>'+this.description+'</td><td>'+value+'</td><td class="text-right"><a href="#" class="btn btn-default delete_discount" rel="'+this.id_discount+'"><i class="icon-remove text-danger"></i>&nbsp;<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Delete','d'=>'Admin.Actions','js'=>1),$_smarty_tpl ) );?>
</a></td></tr>';
			});
	...
	function updateAddressesList(addresses, id_address_delivery, id_address_invoice)
	{
		...
		$.each(addresses, function() {
			if (this.id_address == id_address_invoice)
			{
				...
				invoice_address_edit_link = "<?php echo $_smarty_tpl->tpl_vars['link']->value->getAdminLink('AdminAddresses',true,array(),array('updateaddress'=>1,'realedit'=>1,'liteDisplaying'=>1,'submitFormAjax'=>1));?>
&id_address="+this.id_address+"#";
			...
			if(this.id_address == id_address_delivery)
			{
				...
				delivery_address_edit_link = "<?php echo $_smarty_tpl->tpl_vars['link']->value->getAdminLink('AdminAddresses',true,array(),array('updateaddress'=>1,'realedit'=>1,'liteDisplaying'=>1,'submitFormAjax'=>1));?>
&id_address="+this.id_address+"#";
			}
		...
		{
			$('#addresses_err').show().html('<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'You must add at least one address to process the order.','d'=>'Admin.Orderscustomers.Notification','js'=>1),$_smarty_tpl ) );?>
');
...
$_smarty_tpl->inheritance->instanceBlock($_smarty_tpl, 'Block_20653644615dcb029197c514_78958985', "leadin");
?>
</div>
	<div class="panel form-horizontal" id="customer_part">
		...
		<div id="search-customer-form-group" class="form-group">
			<label class="control-label col-lg-3">
				<span title="" data-toggle="tooltip" class="label-tooltip" data-original-title="<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Search for an existing customer by typing the first letters of his/her name.','d'=>'Admin.Orderscustomers.Help','js'=>1),$_smarty_tpl ) );?>
">
					<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Search for a customer','d'=>'Admin.Orderscustomers.Feature'),$_smarty_tpl ) );?>
				...
				<div class="row">
					<div class="col-lg-6">
						<div class="input-group">
							<input type="text" id="customer" value="" data-customers-search-url="<?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'escape' ][ 0 ], array( $_smarty_tpl->tpl_vars['customersSearchUrl']->value,'html','UTF-8' ));?>
" />
					...
					<div class="col-lg-6">
						<span class="form-control-static"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Or','d'=>'Admin.Global'),$_smarty_tpl ) );?>
&nbsp;</span>
						<a class="fancybox_customer btn btn-default" href="<?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'escape' ][ 0 ], array( $_smarty_tpl->tpl_vars['link']->value->getAdminLink('AdminCustomers',true,array(),array('addcustomer'=>1,'liteDisplaying'=>1,'submitFormAjax'=>1)),'html','UTF-8' ));?>
#">
							<i class="icon-plus-sign-alt"></i>
							<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Add new customer','d'=>'Admin.Orderscustomers.Feature'),$_smarty_tpl ) );?>
			...
			<ul id="old_carts_orders_navtab" class="nav nav-tabs">
				<li class="active">
					<a href="#nonOrderedCarts" data-toggle="tab">
						...
						<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Carts','d'=>'Admin.Global'),$_smarty_tpl ) );?>
					...
					<table class="table">
						<thead>
							<tr>
								...
								<th><span class="title_box"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Total paid','d'=>'Admin.Orderscustomers.Feature'),$_smarty_tpl ) );?>
</span></th>
...
<?php $_smarty_tpl->smarty->ext->_capture->open($_smarty_tpl, 'order_action_name', 'order_action_name', null);?>submitAdd<?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'escape' ][ 0 ], array( $_smarty_tpl->tpl_vars['table']->value,'html','UTF-8' ));
$_smarty_tpl->smarty->ext->_capture->close($_smarty_tpl);?>
<form class="form-horizontal" action="<?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'escape' ][ 0 ], array( $_smarty_tpl->tpl_vars['link']->value->getAdminLink('AdminOrders',true,array(),array($_smarty_tpl->tpl_vars['order_action_name']->value=>1)),'html','UTF-8' ));?>
" method="post" autocomplete="off">
	<div class="panel" id="products_part" style="display:none;">
		<div class="panel-heading">
			<i class="icon-shopping-cart"></i>
			<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Cart','d'=>'Admin.Orderscustomers.Feature'),$_smarty_tpl ) );?>

		</div>
		<div class="form-group">
			<label class="control-label col-lg-3">
				<span title="" data-toggle="tooltip" class="label-tooltip" data-original-title="<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Search for an existing product by typing the first letters of its name.','js'=>1),$_smarty_tpl ) );?>
">
					<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Search for a product','d'=>'Admin.Orderscustomers.Feature'),$_smarty_tpl ) );?>
					...
					<iframe id="customization_list" seamless>
						...
						<head>
							<?php if (isset($_smarty_tpl->tpl_vars['css_files_orders']->value)) {?>
								<?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['css_files_orders']->value, 'media', false, 'css_uri');
if ($_from !== null) {
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
			...
			<div class="form-group">
				<label class="control-label col-lg-3" for="qty"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Quantity','d'=>'Admin.Global'),$_smarty_tpl ) );?>
</label>
				<div class="col-lg-9">
					<input type="text" name="qty" id="qty" class="form-control fixed-width-sm" value="1" />
					<p class="help-block"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'In stock','d'=>'Admin.Orderscustomers.Feature'),$_smarty_tpl ) );?>
 <span id="qty_in_stock"></span></p>
			...
			<div class="form-group">
				<div class="col-lg-9 col-lg-offset-3">
					...
					<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Add to cart','d'=>'Admin.Orderscustomers.Feature'),$_smarty_tpl ) );?>
				...
				<table class="table" id="customer_cart">
					<thead>
						<tr>
							...
							<th><span class="title_box"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Description','d'=>'Admin.Global'),$_smarty_tpl ) );?>
</span></th>
							...
							<th><span class="title_box"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Price per unit','d'=>'Admin.Catalog.Feature'),$_smarty_tpl ) );?>
</span></th>
							...
							<th><span class="title_box"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Price','d'=>'Admin.Global'),$_smarty_tpl ) );?>
</span></th>
						</tr>
					</thead>
					<tbody>
		...
		<div class="form-group">
			<div class="col-lg-9 col-lg-offset-3">
				<div class="alert alert-warning"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'The prices are without taxes.','d'=>'Admin.Orderscustomers.Notification'),$_smarty_tpl ) );?>
</div>
			</div>
		</div>
		...
		<div class="form-group">
			<label class="control-label col-lg-3" for="id_currency">
				<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Currency','d'=>'Admin.Global'),$_smarty_tpl ) );?>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
		...
		<div class="form-group">
			<label class="control-label col-lg-3" for="id_lang">
				<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Language','d'=>'Admin.Global'),$_smarty_tpl ) );?>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
	...
	<div class="panel" id="vouchers_part" style="display:none;">
		<div class="panel-heading">
			...
			<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Vouchers','d'=>'Admin.Orderscustomers.Feature'),$_smarty_tpl ) );?>

		</div>
		<div class="form-group">
			<label class="control-label col-lg-3">
				<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Search for a voucher','d'=>'Admin.Orderscustomers.Feature'),$_smarty_tpl ) );?>
			...
			<div class="col-lg-9">
				<div class="row">
					...
					<div class="col-lg-6">
						<span class="form-control-static"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Or','d'=>'Admin.Global'),$_smarty_tpl ) );?>
&nbsp;</span>
						<a class="fancybox btn btn-default" href="<?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'escape' ][ 0 ], array( $_smarty_tpl->tpl_vars['link']->value->getAdminLink('AdminCartRules',true,array(),array('addcart_rule'=>1,'liteDisplaying'=>1,'submitFormAjax'=>1)),'html','UTF-8' ));?>
#">
							<i class="icon-plus-sign-alt"></i>
							<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Add new voucher','d'=>'Admin.Orderscustomers.Feature'),$_smarty_tpl ) );?>
			...
			<table class="table" id="voucher_list">
				<thead>
					<tr>
						...
						<th><span class="title_box"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Value','d'=>'Admin.Global'),$_smarty_tpl ) );?>
</span></th>
						<th></th>
					</tr>
				</thead>
	...
	<div class="panel" id="address_part" style="display:none;">
		<div class="panel-heading">
			...
			<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Addresses','d'=>'Admin.Global'),$_smarty_tpl ) );?>
		...
		<div class="row">
			<div id="address_delivery" class="col-lg-6">
				<h4>
					...
					<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Delivery','d'=>'Admin.Global'),$_smarty_tpl ) );?>
				...
				<div class="well">
					<a href="" id="edit_delivery_address" class="btn btn-default pull-right fancybox"><i class="icon-pencil"></i> <?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Edit','d'=>'Admin.Actions'),$_smarty_tpl ) );?>
</a>
			...
			<div id="address_invoice" class="col-lg-6">
				...
				<div class="well">
					<a href="" id="edit_invoice_address" class="btn btn-default pull-right fancybox"><i class="icon-pencil"></i> <?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Edit','d'=>'Admin.Actions'),$_smarty_tpl ) );?>
</a>
		...
		<div class="row">
			<div class="col-lg-12">
				<a class="fancybox btn btn-default" id="new_address" href="<?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'escape' ][ 0 ], array( $_smarty_tpl->tpl_vars['link']->value->getAdminLink('AdminAddresses',true,array(),array('addaddress'=>1,'id_customer'=>42,'liteDisplaying'=>1,'submitFormAjax'=>1)),'html','UTF-8' ));?>
#">
					<i class="icon-plus-sign-alt"></i>
					<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Add a new address','d'=>'Admin.Orderscustomers.Feature'),$_smarty_tpl ) );?>
	...
	<div class="panel" id="carriers_part" style="display:none;">
		<div class="panel-heading">
			<i class="icon-truck"></i>
			<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Shipping','d'=>'Admin.Actions'),$_smarty_tpl ) );?>
		...
		<div id="carrier_form">
			<div class="form-group">
				<label class="control-label col-lg-3">
					<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Delivery option','d'=>'Admin.Orderscustomers.Feature'),$_smarty_tpl ) );?>
			...
			<div class="form-group">
				<label class="control-label col-lg-3" for="shipping_price">
					<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Shipping price (Tax incl.)','d'=>'Admin.Orderscustomers.Feature'),$_smarty_tpl ) );?>
			...
			<div class="form-group">
				<div class="checkbox col-lg-9 col-offset-3">
					<label for="carrier_recycled_package">
						...
						<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Recycled packaging','d'=>'Admin.Orderscustomers.Feature'),$_smarty_tpl ) );?>
			...
			<div class="form-group">
				<div class="checkbox col-lg-9 col-offset-3">
					<label for="order_gift">
						...
						<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Gift','d'=>'Admin.Orderscustomers.Feature'),$_smarty_tpl ) );?>

					</label>
				</div>
			</div>
			<div class="form-group">
				<label class="control-label col-lg-3" for="gift_message"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Gift message','d'=>'Admin.Orderscustomers.Feature'),$_smarty_tpl ) );?>
</label>
				<div class="col-lg-9">
	...
	<div class="panel" id="summary_part" style="display:none;">
		<div class="panel-heading">
			...
			<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Summary','d'=>'Admin.Global'),$_smarty_tpl ) );?>
			...
			<div class="row">
				<div class="col-lg-2">
					<div class="data-focus">
						<span><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Total products','d'=>'Admin.Orderscustomers.Feature'),$_smarty_tpl ) );?>
</span><br/>
				...
				<div class="col-lg-2">
					<div class="data-focus">
						<span><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Total vouchers (Tax excl.)','d'=>'Admin.Orderscustomers.Feature'),$_smarty_tpl ) );?>
</span><br/>
				...
				<div class="col-lg-2">
					<div class="data-focus">
						<span><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Total shipping (Tax excl.)','d'=>'Admin.Orderscustomers.Feature'),$_smarty_tpl ) );?>
</span><br/>
				...
				<div class="col-lg-2">
					<div class="data-focus">
						<span><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Total taxes','d'=>'Admin.Orderscustomers.Feature'),$_smarty_tpl ) );?>
</span><br/>
				...
				<div class="col-lg-2">
					<div class="data-focus">
						<span><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Total (Tax excl.)','d'=>'Admin.Orderscustomers.Feature'),$_smarty_tpl ) );?>
</span><br/>
				...
				<div class="col-lg-2">
					<div class="data-focus data-focus-primary">
						<span><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Total (Tax incl.)','d'=>'Admin.Orderscustomers.Feature'),$_smarty_tpl ) );?>
</span><br/>
		...
		<div class="row">
			<div class="order_message_right col-lg-12">
				<div class="form-group">
					<label class="control-label col-lg-3" for="order_message"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Order message','d'=>'Admin.Orderscustomers.Feature'),$_smarty_tpl ) );?>
</label>
					<div class="col-lg-6">
				...
				<div class="form-group">
					...
					<div class="col-lg-9 col-lg-offset-3">
						<a href="javascript:void(0);" id="send_email_to_customer" class="btn btn-default">
							<i class="icon-credit-card"></i>
							<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Send an email to the customer with the link to process the payment.','d'=>'Admin.Orderscustomers.Help'),$_smarty_tpl ) );?>

						</a>
						<a id="go_order_process" href="" class="btn btn-link _blank">
							<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Go on payment page to process the payment.','d'=>'Admin.Orderscustomers.Help'),$_smarty_tpl ) );?>
				...
				<div class="form-group">
					<label class="control-label col-lg-3"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Payment','d'=>'Admin.Global'),$_smarty_tpl ) );?>
</label>
					<div class="col-lg-9">
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
							<?php } else { ?>
								<option value="boorder"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Back office order','d'=>'Admin.Orderscustomers.Feature'),$_smarty_tpl ) );?>
</option>
							<?php }?>
						</select>
					</div>
				...
				<div class="form-group">
					<label class="control-label col-lg-3"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Order status','d'=>'Admin.Shopparameters.Feature'),$_smarty_tpl ) );?>
</label>
					<div class="col-lg-9">
...
if ($_from !== null) {
foreach ($_from as $_smarty_tpl->tpl_vars['order_state']->value) {
?>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
				...
				<div class="form-group">
					<div class="col-lg-9 col-lg-offset-3">
						<button type="submit" name="submitAddOrder" <?php if ($_smarty_tpl->tpl_vars['table']->value) {?>id="<?php echo $_smarty_tpl->tpl_vars['table']->value;?>
_submit_btn"<?php }?> class="btn btn-default" />
							<i class="icon-check"></i>
							<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Create the order','d'=>'Admin.Orderscustomers.Feature'),$_smarty_tpl ) );?>
...
<?php }
/* {block "leadin"} */
class Block_20653644615dcb029197c514_78958985 extends Smarty_Internal_Block
{
public $subBlocks = array (
  'leadin' => 
  array (
    0 => 'Block_20653644615dcb029197c514_78958985',
  ),
);
